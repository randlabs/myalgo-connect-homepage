            ...
            <div className="community">
                    ...
                    <div className="custom-container">
                        <div className="left">
                            ...
                            <a href="https://discord.com/channels/491256308461207573/817420411502329896" className="button button-black mt-5">
                                <svg width="40" viewBox="0 0 71 55" xmlns="http://www.w3.org/2000/svg">
                ...
                <section className="section2">
                    <div className="custom-container">
                        <div className="row1">
                            <div className="left">
                                <svg width="85" height="85" viewBox="0 0 85 85" fill="none" xmlns="http://www.w3.org/2000/svg"> <g clip-path="url(#clip0)">
                                    <path d="M0 85L49.3097 0H61.2711L67.5552 22.1071H80.5423L71.9035 36.7329L84.999 85H71.942L63.5608 53.291L45.1468 85H29.5858L58.4132 36.7329L54.467 18.639L15.207 85.0297L0 85Z" fill="black" /> </g> <defs> <clipPath id="clip0"> <rect width="85" height="85" fill="white" /> </clipPath> </defs>
                                </svg>
                            </div>

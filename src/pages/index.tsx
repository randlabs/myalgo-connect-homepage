...
export default function Home() {
  ...
  const renderIconSection = () => {
    return (
      <div className="icons">
          <div className={clsx("feature-icon icon-container", "scale-on-hover", selectIcon === 0 ? "selected" : "")} onClick={() => applyEffect(0)}>
          <svg width="68" height="63" viewBox="0 0 68 63" fill={selectIcon === 0 ? white : blue} xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={clsx("icon-container", "scale-on-hover", selectIcon === 1 ? "selected" : "")} onClick={() => applyEffect(1)}>
          <svg width="47" height="47" viewBox="0 0 47 47" fill={selectIcon === 1 ? white : blue} xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={clsx("icon-container", "scale-on-hover", selectIcon === 2 ? "selected" : "")} onClick={() => applyEffect(2)}>
          <svg width="41" height="50" viewBox="0 0 41 50" fill={selectIcon === 2 ? white : blue} xmlns="http://www.w3.org/2000/svg">
